...
<head>
	<!-- Basic need -->
	<title>{{ config('app.name', 'Open Pediatrics') }}</title>
	<!-- CSRF Token -->
				...
				<div class="collapse navbar-collapse flex-parent" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav flex-child-menu menu-left">
						...
						<li class="dropdown first">
							...
							{{trans('quickadmin.menus.movies')}}<i class="fa fa-angle-down" aria-hidden="true"></i>
							</a>
							<ul class="dropdown-menu level1">
								<li class="dropdown">
								...
								<li><a href="/movie-detail">Movie single</a></li>
						...
						<li class="dropdown first">
							...
							<ul class="dropdown-menu level1">
								...
								<li><a href="/celebrity-list">celebrity list</a></li>
								<li class="it-last"><a href="/celebrity-detail">celebrity single</a></li>
							</ul>
						</li>
						<li class="dropdown first">
							<a class="btn btn-default dropdown-toggle lv1" data-toggle="dropdown" data-hover="dropdown">
					...
					<ul class="nav navbar-nav flex-child-menu menu-right">
						...
						<li><a href="{{ url('locale/ta') }}" ><i class="fa fa-language"></i> TN</a></li>
						<li class="dropdown first">
							<a class="btn btn-default dropdown-toggle lv1" data-toggle="dropdown" data-hover="dropdown">
